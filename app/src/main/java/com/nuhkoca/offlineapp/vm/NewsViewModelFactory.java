...
/**
 * A {@link ViewModelProvider.Factory} that is injected onto each {@link ViewModel} by {@link NewsViewModelFactory}.
 */
@Singleton
public class NewsViewModelFactory implements ViewModelProvider.Factory {
    ...
    @Inject
    NewsViewModelFactory(Map<Class<? extends ViewModel>, Provider<ViewModel>> creators) {
